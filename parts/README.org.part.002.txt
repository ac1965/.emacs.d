...
#+begin_src emacs-lisp
  ...
  ;;
  ;; This module:
  ;; - enables Vertico globally
  ;; - optionally activates posframe integration
  ;; - augments minibuffer metadata with Marginalia
  ;;
  ;;; Code:
...
#+begin_src emacs-lisp
  ...
  ;;
  ;; Commentary:
  ;; Automatic tangling of updated source blocks in README.org.
  ;;
  ;; This module:
  ;; - tangles only when saving README.org
  ;; - disables confirmation prompts during tangling
  ;; - scopes hooks locally to org-mode buffers
  ;;
  ;;; Code:
