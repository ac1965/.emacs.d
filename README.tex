...
See also: \hyperref[sec:orga252632]{Modular Loader \& Core/Utils design}
for how these rules are enforced structurally.
\subsection{Installation}
\label{sec:org1b4617c}
\subsubsection{Prerequisites}
\label{sec:org993f92e}
\begin{itemize}
\item \textbf{Required}
\begin{itemize}
...
\label{sec:org8a0960a}

\begin{enumerate}
\item Apple Silicon (Primary)
\label{sec:orgb3b7832}
\begin{itemize}
...
\end{enumerate}
\subsection{Tools}
\label{sec:org0b44fc1}
\subsubsection{Graph Capture (Require Dependency Visualization)}
\label{sec:orgaa00ce7}

\begin{enumerate}
\item Purpose
\label{sec:org0d5f668}
...
\end{itemize}
\item Implementation
\label{sec:org8b3f0ed}
\begin{enumerate}
\item tools/tools-graph.el
\label{sec:org785e2a3}
\begin{verbatim}
...
\label{sec:orgb463d40}
\subsubsection{Overview}
\label{sec:org060d855}

\begin{enumerate}
\item Purpose
\label{sec:orgace13f9}
...
\label{sec:orga252632}
\subsubsection{Overview}
\label{sec:orgfcb42ce}

\begin{enumerate}
\item Purpose
\label{sec:org695218b}
...
\end{verbatim}
\subsubsection{core/}
\label{sec:orgd1223ad}
\begin{enumerate}
\item Overview
\label{sec:org2d8348c}
...
\label{sec:org934ceb6}
\begin{enumerate}
\item Overview
\label{sec:org5929b11}
...
\end{enumerate}
\subsubsection{ui/}
\label{sec:orga98fcc6}
\begin{enumerate}
\item Overview
\label{sec:org4489d3f}
...
\end{enumerate}
\subsubsection{orgx/}
\label{sec:orgc62fe1c}
\begin{enumerate}
\item Overview
\label{sec:orgb0ad8ac}
...
\end{enumerate}
\subsubsection{dev/}
\label{sec:org593cdb6}
\begin{enumerate}
\item Overview
\label{sec:org4252a04}
...
\end{enumerate}
\subsubsection{vcs/}
\label{sec:orgd76febc}
\begin{enumerate}
\item Overview
\label{sec:org5d18172}
...
\end{enumerate}
\subsubsection{utils/}
\label{sec:org6613492}
\begin{enumerate}
\item Overview
\label{sec:orgcf5de28}
...
\label{sec:org6504487}
\subsubsection{Overview}
\label{sec:org34530da}

\begin{enumerate}
\item Personal Layer Philosophy
\label{sec:org89d95f2}
...
\end{itemize}
\item What this configuration does
\label{sec:org5c97ccd}

\begin{enumerate}
\item Identity \& safety
\label{sec:orgc48c3b1}
\begin{itemize}
