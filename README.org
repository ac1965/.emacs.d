...
|Property|Value|
|--------|-----|
|Commit|251c070dfde8996189bfb808a0b6f6f5925091b8|
|Branch|master|
|System|aarch64-apple-darwin25.1.0|
|Date|2025-12-12 23:16:16 (JST)|
...
#+begin_src emacs-lisp
  ...
  (leaf consult-notes
    ...
    :config
    (define-key global-map (kbd "C-c n f") #'consult-notes)
    (define-key global-map (kbd "C-c n r") #'my/notes-consult-ripgrep)
    (define-key global-map (kbd "C-c n n") #'my/notes-new-note)
    (define-key global-map (kbd "C-c n d") #'my/notes-open-root))
