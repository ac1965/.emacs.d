...
#+begin_src emacs-lisp
  ...
  ;;
  ;; This module:
  ;; - enables Vertico and Marginalia on first minibuffer use
  ;; - activates vertico-posframe immediately after Vertico initialization
  ;;   to ensure posframe is effective from the very first completion
  ;;
  ;;; Code:
  ...
  (defvar completion-vertico--initialized nil
    "Non-nil once Vertico and Marginalia have been initialized.")

  (defvar completion-vertico--posframe-initialized nil
    "Non-nil once vertico-posframe has been initialized.")

  ;; ---------------------------------------------------------------------------
  ;; Vertico / Marginalia / posframe initialization
  ;; ---------------------------------------------------------------------------

  (defun completion-vertico--init ()
    "Initialize Vertico, Marginalia, and vertico-posframe on first minibuffer use."
    (unless completion-vertico--initialized
      ...
      ;; Enable posframe *after* Vertico is active and geometry is stable
      (when (and (display-graphic-p)
                 (not completion-vertico--posframe-initialized))
      ...
      (remove-hook 'minibuffer-setup-hook #'completion-vertico--init)))

  (add-hook 'minibuffer-setup-hook #'completion-vertico--init)
