...
#+begin_src emacs-lisp
  ...
  (defvar completion-vertico--initialized nil
    "Non-nil once Vertico, posframe, and Marginalia have been initialized.")

  (defun completion-vertico--init ()
    "Initialize Vertico-related completion UI on first minibuffer use."
...
#+begin_src emacs-lisp
  ...
  (defvar orgx-visual--initialized nil
    "Non-nil once org-modern visual settings are applied.")

  (defun orgx-visual--apply ()
    "Apply org-modern visual configuration once."
