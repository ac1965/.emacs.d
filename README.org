...
|Commit|2fcf6b40869f085b32876206179bf1dfe2dc2c93|
|Branch|master|
|System|aarch64-apple-darwin24.3.0|
|Date|2025-03-22 10:58:15 (JST)|
...
#+begin_src emacs-lisp
  ...
  ;; $Lastupdate: 2025/03/23 11:58:25 $
...
#+begin_src emacs-lisp
  ...
  (leaf tabspaces
    ...
    :custom ((tabspaces-keybind-prefix . "C-c t")
             (tabspaces-use-filtered-buffers . t)
             (tabspaces-default-tab . "main")
             (tabspaces-remove-to-default . t)
             (tabspaces-include-buffers . '("*scratch*")))
    :bind (("C-c t s" . tabspaces-switch-or-create-workspace)
           ("C-c t l" . tabspaces-list-workspaces)
           ("C-c t d" . tabspaces-close-workspace)))
...
#+begin_src emacs-lisp
  (leaf-keys
   (("<f1>"          . help)                      ;; Help
    ...
    ("C-c b"         . consult-buffer)            ;; Bufffer View
