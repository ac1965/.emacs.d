...
# - lisp/README.el: Unified tangled config for test/byte-compile
...
#+begin_src emacs-lisp :tangle init.el
  ...
  (let* ((root (cond
    ...
    (dolist (file '("ui" "completion" "org" "lsp" "tools" "etc"))
...
#+begin_src emacs-lisp :tangle lisp/etc.el
  ;;; README.el --- Unified Emacs configuration entry -*- lexical-binding: t; -*-

  ;; Copyright (c) 2021-2025 YAMASHITA, Takao <tjy1965@gmail.com>
  ;; Licensed under the GNU General Public License version 3 or later.

  ;; $Lastupdate: 2025/09/23 15:09:46 $

  ;;; Commentary:
  ;; This file loads tangled configuration from `README.org`.
  ;; It covers package management, modular design, and user-specific overrides.
...
#+begin_src emacs-lisp :tangle lisp/ui.el
  ...
  ;; Unified hook for both GUI and daemon sessions
  (add-hook 'after-make-frame-functions #'font-setup)

  ;; Apply fonts immediately when running in GUI mode
  (when (display-graphic-p)
    (font-setup))
