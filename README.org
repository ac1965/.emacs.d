...
#+begin_src emacs-lisp :tangle init.el
  ...
  ;; 2) Dired + GNU ls (gls) integration (was in early-init; moved here)
  (leaf dired
...
#+begin_src emacs-lisp :tangle lisp/README.el
  ...
  ;; $Lastupdate: 2025/09/15 23:00:39 $
...
#+begin_src emacs-lisp :tangle lisp/README.el
  ...
  (leaf tramp-container
    ;; Do NOT use :ensure t because it's not an external package in most archives
