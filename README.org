...
***** core-switches.el — LSP/UI バックエンド選択
...
***** ui-health-modeline.el — セッション状態表示
...
***** completion-capf-org-src.el — Org SRC ブロック補完
...
***** completion-lsp.el — バックエンド非依存 CAPF
