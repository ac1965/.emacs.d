...
#+begin_src emacs-lisp :tangle init.el
  ...
  ;; ----nn---------------------------------------------------------------
  ;; Fallbacks fsnor variables/functions usually defined in early-init.el
  ;; These only take effect if the symbols are not already bound/defined.
  ;; -------------------------------------------------------------------
  (eval-and-compile
    ;; Basdir (use existing value if already set by early-init).
    (defvar my:d
...
#+begin_src emacs-lisp :tangle lisp/README.el
  ...
  ;; $Lastupdate: 2025/09/16 22:51:34 $
