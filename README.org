...
#+begin_src emacs-lisp
  ...
  ;; Tree-sitter install + load paths must be set early.
  (setq treesit-install-dir my:d:treesit)
  (setq treesit-extra-load-path (list my:d:treesit))

  ;; ---------------------------------------------------------------------------
  ;; 4) straight.el base (kept early, deterministic)
  ;; ---------------------------------------------------------------------------
  ...
  ;; ---------------------------------------------------------------------------
  ;; 5) macOS Homebrew toolchain (best-effort, forward-safe)
  ;; ---------------------------------------------------------------------------
  ...
  (when-let* ((brew (or (getenv "HOMEBREW_PREFIX")
    ...
    (when (file-directory-p bin)
      ...
      ;; -------- Forward-safe GCC detection --------
      (let* ((gcc-candidates
              (directory-files bin t "^gcc-[0-9]+$"))
             (gcc-pairs
              (mapcar (lambda (path)
  ...
  ;; ---------------------------------------------------------------------------
  ;; 6) Native compilation (ELN path + async warning reporting)
  ;; ---------------------------------------------------------------------------
  ...
  ;; ---------------------------------------------------------------------------
  ;; 7) no-littering compatibility (directories owned by early-init)
  ;; ---------------------------------------------------------------------------
  ...
  ;; ---------------------------------------------------------------------------
  ;; 8) Startup performance (GC + file-name-handler filtering, restore on startup)
  ;; ---------------------------------------------------------------------------
  ...
  ;; ---------------------------------------------------------------------------
  ;; 9) Backups / auto-save (disabled in this configuration)
  ;; ---------------------------------------------------------------------------
  ...
  ;; ---------------------------------------------------------------------------
  ;; 10) Early UI defaults (avoid flicker; fullscreen applied once post-setup)
  ;; ---------------------------------------------------------------------------
  ...
  ;; ---------------------------------------------------------------------------
  ;; 11) Startup echo (quiet by default; keep standard behavior)
  ;; ---------------------------------------------------------------------------
