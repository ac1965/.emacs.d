...
#+begin_src emacs-lisp :tangle early-init.el
  ...
  (defun my--restore-gc-settings ()
    ...
    (remove-hook 'emacs-startup-hook #'my--restore-gc-settings))
...
#+begin_src emacs-lisp :tangle init.el
  ...
  (leaf exec-path-from-shell
    :straight t
    :if (memq window-system '(mac ns))           ;; Only on macOS GUI/NS
    :init
  ...
  ;; Load custom-file if it exists (safe fallback, no errors)
...
#+begin_src emacs-lisp :tangle lisp/README.el
  ...
  ;; $Lastupdate: 2025/09/23 11:26:18 $
