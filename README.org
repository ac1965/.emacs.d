...
#+begin_src emacs-lisp
  ...
  ;; $Lastupdate: 2025/04/27 09:47:08 $
...
#+begin_src emacs-lisp
  ...
  (leaf completion-settings
    ...
    (defun cc/setup-embark-vertico-directory ()
    ...
    (add-hook 'vertico-mode-hook #'cc/setup-embark-vertico-directory)
...
#+begin_src emacs-lisp
  ...
  ;;
  (add-hook 'after-save-hook #'cc/auto-tangle-init-org)
#+end_src
