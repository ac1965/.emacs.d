...
#+begin_src emacs-lisp :tangle early-init.el
  ...
  (defun my--restore-startup-toggles ()
    "Restore GC and file-name-handler safely after init."
...
#+begin_src emacs-lisp :tangle init.el
  ...
  (eval-and-compile
    ...
    (defvar my:d:elpa  (or (and (boundp 'my:d:elpa)  my:d:elpa)
                           (expand-file-name "elpa/"   my:d:var)))
    (defvar my:d:eln   (or (and (boundp 'my:d:eln)   my:d:eln)
                           (expand-file-name "eln-cache/" my:d:var)))
    ...
    ;; Ensure package.el respects our elpa dir even if early-init wasn't loaded.
    (with-eval-after-load 'package
      (unless (and (boundp 'package-user-dir) package-user-dir)
        (setq package-user-dir my:d:elpa)))
  ...
  ;; Bootstrap leaf if missing.
  (unless (package-installed-p 'leaf)
    (package-refresh-contents)
    (package-install 'leaf)) ;; let it signal on failure (visible)
...
#+begin_src emacs-lisp :tangle README.el
  ...
  ;; $Lastupdate: 2025/09/01 17:29:45 $
