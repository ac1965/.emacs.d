...
#+begin_src emacs-lisp
  ...
  ;; $Lastupdate: 2025/01/11 16:01:19 $
  ...
  (leaf KeyBinding
    ...
    (leaf-keys
     ...
     (("C-h"           . backward-delete-char)  ;; Delete character before the cursor
      ...
      ;; Miscellaneous
      ("C-c C-v"      . my/open-by-vscode)      ;; Open the current buffer in Visual Studio Code
      ("C-c C-p"      . my/print-build-info)    ;; Print about the current Emacs build
