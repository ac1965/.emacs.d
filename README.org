...
#+begin_src emacs-lisp :tangle early-init.el
  ...
  ;; One-shot: make the face valid right now
...
#+begin_src emacs-lisp :tangle init.el
  ...
  ;; License: GNU GPL v3 or later
  ;;
  ;; $Lastupdate: 2025/10/08 01:15:32 $
  ;;
  ;;; Commentary:
...
#+begin_src emacs-lisp :tangle lisp/ui/ui-theme.el
  ...
  ;;; Guard: rewrite nil face-attrs to 'unspecified before they are applied
  ...
  ;; Keep your existing normalization hooks as a safety net:
  ;; (add-hook 'enable-theme-functions (lambda (_th) (ui--normalize-faces)))
