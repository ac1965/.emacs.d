...
#+begin_src emacs-lisp
  ...
  ;; $Lastupdate: 2025/01/19 09:05:38 $
...
#+begin_src emacs-lisp
  ...
  ^Window Management^
  ----------------------------------
  [_o_] Other window  [_s_] Split window  [_d_] Delete window
  [_f_] Find file     [_j_] Find file other window
  [_m_] Make frame    [_r_] Restart Emacs [_q_] Quit
  "
        ("o" other-window)
