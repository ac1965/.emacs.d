...
- define layer load order
- isolate module loading
- handle optional modules safely
- prevent dependency inversion
...
#+begin_src emacs-lisp :tangle lisp/core/core-history.el
...
See the LICENSE file for details.** Coding Rules
:PROPERTIES:
