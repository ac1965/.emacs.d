...
Set to `none' to disable LSP activation entirely."
  ...
  (defun core-switches--enable-lsp (choice)
    "Activate the LSP backend identified by CHOICE.
Returns non-nil on success, nil on failure.  CHOICE must be one of the
values defined in `my:use-lsp': `none', `eglot', or `lsp'."
    (pcase choice
