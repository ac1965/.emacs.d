...
#+begin_src emacs-lisp :tangle init.el
  ...
  ;; Disable package.el to avoid double initialization (straight.el will manage).
  (setq package-enable-at-startup nil)

  ;; Bootstrap straight.el
  (defvar bootstrap-version)
  (let ((bootstrap-file
         (expand-file-name "straight/repos/straight.el/bootstrap.el" my:d:var))
        (bootstrap-version 6))
...
#+begin_src emacs-lisp :tangle lisp/README.el
  ...
  ;; $Lastupdate: 2025/09/15 20:57:54 $
