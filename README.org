...
#+begin_src emacs-lisp
  ...
  (leaf org
    ...
    ;; assets/img/cover/custom/<EXPORT_FILE_NAME>.jpg に置いた上で、この値を
    ;; :cover "custom/<EXPORT_FILE_NAME>.jpg" に書き換える（deploy.sh の Tier1: 明示指定）。
...
#+begin_src emacs-lisp
  ...
  (leaf emms
    ...
    :commands (emms-play-dired emms-play-directory emms-play-directory-tree
