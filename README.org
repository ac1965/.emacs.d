...
;; $Lastupdate: 2025/01/25 15:22:29 $
...
- **Font Setup:**
  ...
  - `my:font-family` and `my:font-size` are used to define the default font and size.
...
#+begin_src emacs-lisp
  ...
  (leaf Fonts
    ...
    (unless (boundp 'my:font-family)
      (setq my:font-family "JetBrains Mono")) ;; Default font family
    (unless (boundp 'my:font-size)
      (setq my:font-size 16)) ;; Default font size
