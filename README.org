...
#+begin_src emacs-lisp :tangle user.el
  ...
  ;; Load and configure sis (Smart Input Source)
  ;; `brew install macism`
  (leaf sis
    :ensure t
    :config
    ;; First run: (sis-get) with each input method active to get IDs
    (sis-ism-lazyman-config
     "com.apple.keylayout.US"
     "com.apple.inputmethod.Japanese" 'macism)

    ;; Enable global mode to respect context and display in modeline
    (sis-global-respect-mode t)
    (sis-global-cursor-color-mode t)) ;; Optional: change cursor color based on input source
...
#+begin_src emacs-lisp :tangle README.el
  ...
  ;; $Lastupdate: 2025/08/30 10:08:19 $
...
#+begin_src emacs-lisp :tangle README.el
  (leaf eww
    :ensure nil
    :custom ((eww-search-prefix . "https://www.google.com/search?q=") ;; Default search engine
             (eww-download-directory . "~/Downloads"))                ;; Download directory
    :config
    ;; Save history and bookmarks
    (setq eww-bookmarks-file (locate-user-emacs-file "eww-bookmarks"))
