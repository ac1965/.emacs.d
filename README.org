...
|Commit|c91c591f0f0cc774647c32bdcf05bb3a9551e340|
|Branch|master|
|System|aarch64-apple-darwin24.3.0|
|Date|2025-02-02 13:07:09 (JST)|
...
;; $Lastupdate: 2025/02/02 15:01:16 $
...
#+begin_src emacs-lisp
  ...
  (leaf tree-sitter-langs
    :ensure t
    :config
    (ignore-errors (tree-sitter-langs-install-grammars)))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (leaf Org-mode
    ...
    (leaf org
      ...
      (setq org-agenda-files (remove (expand-file-name "archives" org-directory)
  				   org-agenda-files))
