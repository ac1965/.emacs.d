...
personal/user.el via setopt."
  ...
  (defun core-editing--save-on-focus-out (_frame)
    "Save all file-backed buffers when FRAME loses focus."
    (when core-autosave-save-on-focus-out
      (core-editing--save-all-buffers)))

  (defun core-editing--save-on-window-change (frame)
    "Save all file-backed buffers when the selected window changes in FRAME."
  ...
  (defun core-editing--autosave-init ()
    ...
    ;; 4. Window-change hook (covers buffer switching in the same frame).
